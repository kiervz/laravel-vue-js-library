...
const routes = [
    ...
    { path: '/book', name: 'Book', component: require('../components/Pages/Book.vue').default, meta: { requiresAuth: true } },
    { path: '/book-category', name: 'BookCategory', component: require('../components/Pages/BookCategory.vue').default, meta: { requiresAuth: true } },
